...
(function () {
  ...
  if (typeof wizardValidation !== undefined && wizardValidation !== null) {
    ...
    const wizardValidationFormStep3 = wizardValidationForm.querySelector('#social-links-validation');
      const wizardValidationFormStep4 = wizardValidationForm.querySelector('#social-links-validation1');
      const wizardValidationFormStep5 = wizardValidationForm.querySelector('#social-links-validation2');
      const wizardValidationFormStep6 = wizardValidationForm.querySelector('#social-links-validation3');
